...
class FormController extends Controller{
    ...
    public function creerCompteGestionnaire(Request $request){
        ...
        $formBuilder
            ...
            ->add('Telephone',TextType::class, array('label' => 'T̩l̩phone', 'required' => true ))
            ->add('Mail',TextType::class, array('required' => true))
    ...
    public function creerCompteUtilisateurEtudiantAction(Request $request){
        ...
        $formBuilder
            ...
            ->add('Ville',TextType::class, array('required' => true))
            ->add('Telephone',TextType::class, array('label' => 'T̩l̩phone','required' => true))
            ->add('CNI',FileType::class, array('label' => 'Pi̬ce d\'identit̩' ,'required' => false))
            ...
            ->add('Niveau_d_etude',ChoiceType::class, array('label' => 'Niveau d\'̩tudes','choices' => array(
                'Bac' => 'Bac',
                'Bac+1' => 'Bac+1',
                'Bac+2' => 'Bac+2',
                'Bac+3' => 'Bac+3',
            ...
            ->add('Dernier_diplome',TextType::class, array('label' => 'Dernier dipl̫me','required' => true))
            ->add('Mail',TextType::class, array('required' => true))
            ->add('Password',  PasswordType::class, array('label' => 'Mot de passe','required' => true))
            ->add('Confirm_password', PasswordType::class, array('label' => 'Confirmez le mot de passe','required' => true))
            //->add('RIB',TextType::class, array('label' => 'RIB' ),array('required' => false))
            ->add('Diplome',FileType::class, array('label' => 'Dipl̫me','required' => false))
    ...
    public function creerCompteUtilisateurProAction(Request $request){
        ...
        $formBuilder
            ->add('Nom',TextType::class, array('required' => true))
            ->add('Prenom',TextType::class, array('label' => 'Pr̩nom' ), array('required' => true))
            ->add('Telephone',TextType::class, array('label' => 'T̩l̩phone' ),array('required' => true))
            ->add('Rue',TextType::class, array('required' => true))
            ->add('Code_postal',TextType::class, array('required' => true))
            ->add('Ville',TextType::class, array('required' => true))
            ->add('CNI',FileType::class, array('label' => 'Pi̬ce d\'identit̩'),array('required' => false))
            ->add('Mail',TextType::class, array('required' => true))
            ...
            ->add('Denomination',TextType::class, array('label' => 'D̩nomination' ),array('required' => true))
    ...
    public function creationDemandeAction(Request $request){
        ...
        $formBuilder
            ...
            ->add('Classe_frequentee_n_1',TextType::class, array('label' => 'Classe fr̩quent̩e N-1','required' => true))
            ->add('Ville_n_1',TextType::class, array('label' => 'Ville N-1','required' => true))
            ->add('Specialite_n_1',TextType::class, array('label' => 'Sp̩cialit̩ N-1','required' => true))
            ->add('Etablissement',TextType::class, array('required' => true))
            ->add('Adresse',TextType::class, array('required' => true))
            ->add('Code_postal',TextType::class, array('required' => true))
            ->add('Classe_frequentee',TextType::class, array('label' => 'Classe fr̩quent̩e','required' => true))
            ->add('Ville',TextType::class, array('required' => true))
            ->add('Specialite',TextType::class, array('label' => 'Sp̩cialit̩','required' => true))
            ->add('Memoire',FileType::class, array('label' => 'M̩moire','required' => false))
            ...
            ->add('Certificat_de_scolarite',FileType::class, array('label' => 'Certificat de scolarit̩','required' => false))
            ->add('Certificat_de_scolarite_N_1',FileType::class, array('label' => 'Certificat de scolarit̩ N-1','required' => false))
            ...
            ->add('aides',ChoiceType::class, array('label' => 'Aides sollicit̩s','required' => true, 'multiple' => true, 'expanded' => true, 'choices' => array(
                    'Installation' => 'Installation',
                    'Scolarit̩' => 'Scolarit̩',
                    'Transport' => 'Transport',
                    'Achat de mat̩riels scolaire' => 'Achat de mat̩riels scolaire'
                )))
            ->add('Valider',SubmitType::class)
        ;
